...
$(document).ready(function(){
$('#content').prepend('<a onclick="$(\'#main\').toggleClass(\'nosidebar\')" style="position:absolute;right:12px;top:40px;transform:rotate(90deg);transform-origin:right bottom;">Sidebar</a>').css('position','relative');
});
